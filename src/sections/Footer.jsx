...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-[#1E293B] px-10 py-16 mt-20">
          ...
          <div className="flex justify-center">
            <div className="flex flex-col space-y-6 items-center md:items-start">
              ...
              <p className="text-gray-400 text-center md:text-left text-sm max-w-xs">
                Building scalable, user‑centric applications from the ground up to drive real business results.
              </p>
            ...
            <div className="flex flex-col space-y-6 items-center md:items-start">
              ...
              <div className="space-y-3 w-full max-w-xs">
                <div className="flex items-center space-x-3 text-gray-400">
                  ...
                  <span className="hover:text-white transition-all duration-300 cursor-pointer">agrawalvanshn@gmail.com</span>
                </div>
                <div className="flex items-center space-x-3 text-gray-400">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="hover:text-white transition-all duration-300 cursor-pointer">+91 7378882317</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 bg-blue-600 text-white p-3.5 rounded-full shadow-xl hover:bg-blue-700 transition-all duration-300 group z-50 cursor-pointer"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
